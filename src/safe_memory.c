...
static void print_zero_memory_requested(const_cstring calling_function,
        const_cstring target_function, const_cstring variable_name)
{
...
static void print_memory_allocation_error(const_cstring calling_function,
        const_cstring target_function, const size_t size)
{
    fprintf(stderr, "Error allocating memory: The function '%s' called '%s' "
